...
<html lang="en">
	<head>
		...
		/>
		<title>SPA</title>
		<link rel="stylesheet" href="../css/pagAdmi.css" />
			...
			<div class="container-hero">
				<div class="container hero">
					...
					<div class="container-user">
					    <a href="../html/perfilAdmi.php">
						<i class="fa-solid fa-user"></i>
					    </a>
						<a href="../html/pagprincipal.php">
		...
		<main class="main-content">
				...
				<div class="container-products">
					...
					<div class="card-product">
						...
						<div class="content-card-product">
							...
							<p class="price">$30.000 <span>$50.000</span></p>
						</div>
					</div>
					<!--  -->
					<div class="card-product">
			...
			<section class="container blogs">
				...
				<div class="container-blogs">
					<div class="card-blog">
						<div class="container-img">
							<img src="../img/verdura.jpg" alt="Imagen Blog 1" />
					...
					<div class="card-blog">
						<div class="container-img">
							<img src="../img/verdura.jpg" alt="Imagen Blog 2" />
							<div class="button-group-blog">
								<span>
									<i class="fa-solid fa-magnifying-glass"></i>
								</span>
